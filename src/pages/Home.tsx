        ...
        <div className="max-w-6xl mx-auto relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredProjects.map((project, i) => (
              ...
              >
                <div className="group relative bg-cosmic-800/80 backdrop-blur-sm rounded-xl p-6 transition-all duration-300 border border-cosmic-600/30 hover:border-star-gold/30 hover:shadow-[0_0_30px_-5px_rgba(255,215,0,0.15)] hover:-translate-y-1 cursor-pointer"
                  onClick={() => window.open(project.liveUrl || project.repoUrl, '_blank')}
                >
                  {/* GitHub badge */}
                  <a
                    ...
                    className="absolute top-3 right-3 z-10 text-cosmic-400 hover:text-white transition-colors"
