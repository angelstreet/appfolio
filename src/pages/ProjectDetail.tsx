    ...
    <div className="min-h-screen bg-[#050510] relative overflow-hidden">
      ...
      <section className="relative z-10 py-20 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          >
            <img src={project.logoImage} alt={project.title} className="w-20 h-20 object-contain rounded-2xl mb-6 bg-white/90 p-2" />
                ...
                >
                  ...
                  >
                    <div className="flex items-center gap-4">
                      <img src={related.logoImage} alt={related.title} className="w-10 h-10 object-contain rounded-lg bg-white/90 p-1" />
                      <div>
